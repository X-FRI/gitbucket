...
""")
    ...
    describe("toHtml") {
        it("should fix url at the repository root") {
            ...
            assert(
              html ==
                  """<p><a href="http://localhost:8080/user/repo/blob/master/CHANGELOG.md">ChangeLog</a></p>"""
            )
        }
        ...
        it("should fix sub directory url at the file list") {
            ...
            assert(
              html ==
                  """<p><a href="http://localhost:8080/user/repo/blob/master/sub/dir/CHANGELOG.md">ChangeLog</a></p>"""
            )
        }
